 ...
 * 
 * Output: training-data/effect-code-samples.json
 */

import * as Path from "node:path"
import * as Fs from "node:fs"

const TRAINING_DIR = "C:/Users/kodep/Training"
const OUTPUT_DIR = "C:/Users/kodep/Training/extracted-code"
...
function extractTrainingData(): void {
  ...
  const repositories = [
    {
      name: "effect-smol",
      path: Path.join(TRAINING_DIR, "effect-smol", "packages"),
      includePatterns: ["ai", "effect"],
    },
    {
      name: "effect",
      path: Path.join(TRAINING_DIR, "effect", "packages"),
      includePatterns: ["ai", "effect", "cli", "cluster", "platform", "sql", "typeclass", "workflow"],
    },
    {
      name: "opencode",
      path: Path.join(TRAINING_DIR, "opencode", "packages"),
      includePatterns: ["llm"],
    },
  ]
  ...
  console.log("\nProcessing examples...")
  const examplesPath = Path.join(TRAINING_DIR, "effect-examples")
